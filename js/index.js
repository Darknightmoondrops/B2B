...
function slidechenger2(n) {
    ...
    if (n > page.length) { pagenumber2 = 1 }
    if (n < 1) { pagenumber2 = page.length }
    for (i = 0; i < page.length; i++) {
        page[i].style.display = "none";
    }
    for (i = 0; i < number.length; i++) {
...
function slidechenger3(n) {
    ...
    if (n > page.length) { pagenumber3 = 1 }
    if (n < 1) { pagenumber3 = page.length }
    for (i = 0; i < page.length; i++) {
        page[i].style.display = "none";
    }
    for (i = 0; i < number.length; i++) {
...
function slidechenger4(n) {
    ...
    if (n > page.length) { pagenumber4 = 1 }
    if (n < 1) { pagenumber4 = page.length }
    for (i = 0; i < page.length; i++) {
        page[i].style.display = "none";
    }
    for (i = 0; i < number.length; i++) {
